...
const { createPostController, getPostDetailsController, getParticularPostController, postLikeController, getFeedController, postUnlikeController } = require('../controllers/post.controller')
